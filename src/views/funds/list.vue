    ...
    <div class="row">
      <div class="col-md-2">
        <div class="form-group">
          <label for="fund_category" class="label">Category</label>
          <select
            name="fund_category"
            id="fund_category"
            class="form-control"
      ...
      <div class="col-md-2">
        <div class="form-group">
          <label for="fund_type" class="label">Types</label>
    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table table-light table-bordered table-striped table-hover" v-if="pageItems.length">
          ...
          <tbody>
            <tr v-for="(fund, index) in pageItems" :key="fund.code">
              <td>{{index+1}}</td>
              <td>
        ...
        <p class="no-data" v-else>No Fund data available.</p>
      </div>
    </div>
    <div class="row">
